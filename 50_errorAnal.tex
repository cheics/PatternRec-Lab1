...
Training data was used as original error boundaries. The test data was generated as another set of data with the same parameters as the original class training data, but with a different random seed.
